...
function combatSchema() {
  return new SchemaField({
    ...
    pendingDamageModifier: numberField(0, { min: -20, max: 20 }),
    pendingExtraWounds: numberField(0, { min: 0, max: 99 }),
    ...
    activeStanceId: textField(""),
    activeStanceName: textField(""),
    activeStanceCathartic: new BooleanField({ required: true, initial: false }),
    activeStanceRounds: numberField(0, { min: 0, max: 999 }),
    activeStanceNotes: textField(""),
...
export class OgreGateTechniqueData extends OgreGateBaseItemData {
  static defineSchema() {
    return {
      ...
      targetNumber: numberField(6, { min: 0, max: 20 }),
      qiRank: numberField(1, { min: 0, max: 99 }),
      attackModifier: numberField(0, { min: -10, max: 10 }),
      catharticAttackModifier: numberField(0, { min: -10, max: 10 }),
      damage: textField(""),
      damageModifier: numberField(0, { min: -10, max: 10 }),
      catharticDamageModifier: numberField(0, { min: -10, max: 10 }),
      directWounds: textField(""),
      totalSuccessDirectWounds: textField(""),
      catharticDirectWounds: textField(""),
      catharticTotalSuccessDirectWounds: textField(""),
      directWoundsNote: textField(""),
      targetDrains: textField(""),
      totalSuccessTargetDrains: textField(""),
      catharticTargetDrains: textField(""),
      catharticTotalSuccessTargetDrains: textField(""),
      targetDrainsNote: textField(""),
      targetEffects: textField(""),
      totalSuccessTargetEffects: textField(""),
      catharticTargetEffects: textField(""),
      catharticTotalSuccessTargetEffects: textField(""),
      targetEffectsNote: textField(""),
      selfWounds: numberField(0, { min: 0, max: 99 }),
      catharticSelfWounds: numberField(0, { min: 0, max: 99 }),
      catharticImbalanceMultiplier: numberField(1, { min: 1, max: 10 }),
      consequenceNote: textField(""),
      openDamage: new BooleanField({ required: true, initial: false }),
      catharticOpenDamage: new BooleanField({ required: true, initial: false }),
      extraWounds: numberField(0, { min: 0, max: 99 }),
      catharticExtraWounds: numberField(0, { min: 0, max: 99 }),
      counter: textField(""),
      secret: new BooleanField({ required: true, initial: false }),
      accessNotes: textField(""),
      combination: new BooleanField({ required: true, initial: false }),
      prerequisiteTechniques: textField(""),
      requirementNotes: textField(""),
      requiredFlaws: textField(""),
      requiredSkillRanks: textField(""),
      catharticEffect: textField(""),
      formation: new BooleanField({ required: true, initial: false }),
      formationParticipants: numberField(0, { min: 0, max: 99 }),
      formationNotes: textField("")
    };
  }
}
